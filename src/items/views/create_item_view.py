...
def createItem(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            form.cleaned_data["security_index"] = test_password_strength(form.cleaned_data["password"])
...
def test_password_strength(password: str) -> int:
    ...
    number_different_characters = sum((has_upper, has_lower, has_digit, has_special))
