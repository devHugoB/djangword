...
from .views import createItem, listItems, updateItem, deleteItem, showPassword, shareItem, sharedItems, delete_item_shared
...
urlpatterns = [
    ...
    path("shared_item/<int:shared_item_id>", delete_item_shared, name='delete_item_shared'),
]